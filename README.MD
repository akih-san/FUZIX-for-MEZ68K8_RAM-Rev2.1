...
<br>
　を使っています。[MPLAB X IDE v6.25](https://www.microchip.com/en-us/tools-resources/develop/mplab-x-ide)コンパイラは、XC8を使用しています。<br>

<br>
・universal moniter 68000、及びEnhanced 68k BASICは、[Macro Assembler AS V1.42](http://john.ccac.rwth-aachen)
[Macro Assembler AS V1.42](http://john.ccac.rwth-aachen.de:8000/as) を
　使用してバイナリを作成しています。<br>
<br>
