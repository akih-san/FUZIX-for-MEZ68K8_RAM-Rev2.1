...
USE_SFDECODE = 0		; Decode Stack Frame
...
INIVEC:
	...
	DC.L	IRQ5_H		; Level 5 Interrupt Autovector
	DC.L	DUMMY_H		; Level 6 Interrupt Autovector
	DC.L	NMI_H		; Level 7 Interrupt Autovector
...
NMI_MSG:	DC.B	CR,LF,"NMI Interrupt!!",CR,LF,$00
